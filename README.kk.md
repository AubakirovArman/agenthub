...
- command policy enforcement, sandbox level evaluation, remote runner dispatch, diff guard, sync check, rollback handlers және commit-on-success;
