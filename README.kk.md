...
Толық құжаттама: [How it works](docs/how-it-works.en.md), [PRD tracker](docs/prd-tracker.kk.md), [PRD audit](docs/prd-audit.kk.md), [PRD v2](docs/prd-v2.kk.md), [PRD v3](docs/prd-v3.kk.md), [Repository Rename](docs/repository-rename.kk.md), [Release Engineering](docs/release-engineering.kk.md), [Install And Packaging](docs/install-packaging.kk.md), [Product CLI](docs/product-cli.kk.md), [Local Shell](docs/local-shell.kk.md), [Skill Standard Library](docs/skill-standard-library.kk.md), [Product Fixtures](docs/product-fixtures.kk.md), [Testing Strategy](docs/testing-strategy.kk.md), [Security Hardening](docs/security-hardening.kk.md), [TUI](docs/tui.kk.md), [Web Dashboard](docs/web-dashboard.kk.md), [Metrics Dashboard](docs/metrics-dashboard.kk.md), [Analytics History](docs/analytics-history.kk.md), [Hosted/Team Surfaces](docs/hosted-team-surfaces.kk.md), [AAL](docs/aal.kk.md), [Workspaces](docs/workspaces.kk.md), [Workspace Runtime](docs/workspace-runtime.kk.md), [Domain Runtimes](docs/domain-runtimes.kk.md), [MediaWorkspace](docs/media-workspace.kk.md), [Research](docs/research-profile.kk.md), [Backend TDD](docs/backend-tdd-verifier.kk.md), [DB Migration](docs/db-migration-verifier.kk.md), [Command Policy](docs/command-policy.kk.md), [Sandbox Levels](docs/sandbox-levels.kk.md), [Remote Runner](docs/remote-runner.kk.md), [Hardened Runner](docs/hardened-runner.kk.md), [Network Policy](docs/network-policy-server.kk.md), [WAL](docs/wal.kk.md), [Effect Ledger](docs/effect-ledger.kk.md), [Rollback Handlers](docs/rollback-handlers.kk.md), [Resume/Retry](docs/resume-retry.kk.md), [Transaction Watch](docs/tx-watch.kk.md), [Transaction Explain](docs/tx-explain.kk.md), [Transaction Undo](docs/tx-undo.kk.md), [Smart Sync](docs/smart-sync.kk.md), [VCM-OS Memory](docs/vcm-os-memory.kk.md), [Reference Web Fixture](docs/reference-web-fixture.kk.md), [IDE](docs/ide.kk.md), [Natural language](docs/natural-language.kk.md), [Topologies](docs/topologies.kk.md), [Agent adapters](docs/agent-adapters.kk.md), [Runtime and repair](docs/runtime-repair.kk.md), [Context maps](docs/context-maps.kk.md), [LLM Gateway](docs/llm-gateway.kk.md), [Plugin ecosystem](docs/plugin-ecosystem.kk.md), [Plugin signatures](docs/plugin-signatures.kk.md), [Plugin Governance](docs/plugin-governance.kk.md), [Enterprise](docs/enterprise.kk.md), [Русский](docs/how-it-works.ru.md), [中文](docs/how-it-works.zh.md), [Қазақша](docs/how-it-works.kk.md)
...
- `CodeGitWorkspace` runtime abstraction арқылы git worktree ішінде оқшауланған `CodeWorkspace`, `ContentWorkspace`, `DataWorkspace`, `InfraWorkspace`, `MediaWorkspace`, `ResearchWorkspace`;
- Rust, Terraform, Python data, media render және research citation work үшін domain runtime packs;
...
- VCM memory staging, promotion, typed schemas, schema-filtered retrieval, failed-attempt warnings, views және audit;
...
- plugin governance permissions, publisher/review metadata, compatibility checks, advisories және scorecards;
...
- task classification, topology selection, report artifacts және project scoreboard бар opt-in adaptive orchestration;
...
- installable CLI quality gates үшін product fixture projects және smoke scripts;
- OS capability detection және resource limit policy бар sandbox hardening report;
...
Source арқылы жинау және тексеру:
...
Release artifact installers [Install And Packaging](docs/install-packaging.kk.md) ішінде жазылған.
