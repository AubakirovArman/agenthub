...
Main open areas: standalone AAL grammar, MediaWorkspace, full Research profile, manager/worker and tournament topologies, specialized backend/database verifiers, command policy enforcement, strong sandbox levels, real remote runner execution, cryptographic plugin signing, metrics dashboards, and formal WAL.
