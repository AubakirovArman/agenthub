...
| `0.4.115` | Long-session and compaction dogfood | Perf profile plus real long sessions prove compaction, resume/rewind, memory context, and cost receipts stay stable under extended use |
