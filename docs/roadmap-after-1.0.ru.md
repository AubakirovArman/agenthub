...
1. Run `scripts/rc-acceptance.sh` as a local rehearsal after risky runtime changes; it proves stats, Ops no-bootstrap, approval UX, resume and undo/rewind still produce inspectable artifacts.
