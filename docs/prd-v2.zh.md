...
工作 backlog 位于 `prd/v2/`。当前 implementation task 是 effect ledger foundation：`.agent/tx/<tx-id>/effects.jsonl` 记录 planned、applied、verified、rollback-pending、rolled-back 和 non-rollbackable effects。
