...
工作 backlog 位于 `prd/v2/`。Effect ledger、rollback handlers、resume/retry/resolve、Smart Sync、Workspace Runtime trait、LLM Provider Gateway、VCM-OS typed memory 和 Hardened Runner 已完成。下一项 task 是 AAL v2 semantics。
