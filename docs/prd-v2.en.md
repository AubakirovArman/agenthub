...
The working backlog is in `prd/v2/`. Effect ledger, rollback handlers, resume/retry/resolve, Smart Sync, and Workspace Runtime trait are done. The next task is the LLM Provider Gateway.
