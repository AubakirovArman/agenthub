...
Рабочий backlog находится в `prd/v2/`. Effect ledger, rollback handlers, resume/retry/resolve, Smart Sync, Workspace Runtime trait и LLM Provider Gateway сделаны. Следующая task — VCM-OS typed memory.
