...
Рабочий backlog находится в `prd/v2/`. Effect ledger, rollback handlers, resume/retry/resolve, Smart Sync и Workspace Runtime trait сделаны. Следующая task — LLM Provider Gateway.
