...
`readiness completion` — aggregate completion bundle. Он объединяет финальное readiness-решение, current action plan, prompt-to-artifact checklist, focused evidence status, raw provider statuses, source files, blocker scope, blocked checks, latest Kimi RC operator receipt summary и verification commands, чтобы release automation отвечала "готово/не готово" без ручной склейки нескольких reports.
