...
| 16. Agent Orchestration | Partial | single, planner/executor, generator/critic, reviewer/repair, swarm research, and manager/worker exist; tournament is open. |
...
| Orchestration | single, planner/executor, generator/critic, reviewer/repair, swarm, manager/worker | tournament |
