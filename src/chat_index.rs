...
pub struct ChatEventView {
    ...
    pub memory_records_available: Option<usize>,
    pub memory_records_expired: Option<usize>,
    pub memory_records_conflict_suppressed: Option<usize>,
    pub memory_records_budget_dropped: Option<usize>,
    pub memory_tokens: Option<usize>,
    pub max_memory_tokens: Option<usize>,
    pub recent_messages: Option<usize>,
    pub recent_messages_dropped: Option<usize>,
    pub context_compressed: Option<bool>,
    pub pending_memory_included: Option<bool>,
