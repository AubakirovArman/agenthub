...
pub fn rotate_provider_key(
    ...
    out.push_str("next\t1\tagenthub providers test kimi\n");
    out.push_str("next\t2\tscripts/kimi-auth-check.sh\n");
    out.push_str("next\t3\tscripts/rc-evidence-collect.sh\n");
    out.push_str("next\t4\tscripts/rc-dogfood-gate.sh --check\n");
