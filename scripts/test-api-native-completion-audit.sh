...
grep -q $'next\t2\tagenthub providers preflight-key kimi --from-file <new-key-file>' "$TMP/blocked.out"
grep -q $'next\t3\tagenthub providers rc-unblock kimi --from-file <new-key-file>' "$TMP/blocked.out"
grep -q $'next\t4\tagenthub providers unblock kimi' "$TMP/blocked.out"
grep -q $'next\t5\tagenthub providers rotate-key kimi --from-file <new-key-file>' "$TMP/blocked.out"
...
grep -q $'next\t12\tagenthub readiness blockers --json --check' "$TMP/blocked.out"
grep -q $'next\t13\tagenthub readiness audit --json --check' "$TMP/blocked.out"
