...
- command policy enforcement、sandbox level evaluation、remote runner dispatch、diff guard、sync check、rollback handlers 和成功后 commit；
