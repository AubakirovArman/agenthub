...
- command policy enforcement、sandbox level evaluation、remote runner dispatch、diff guard、smart sync、rollback handlers 和成功后 commit；
