...
- real LLM Gateway provider execution для CLI templates и OpenAI-compatible HTTP endpoints с retry/backoff;
- product fixture projects и smoke scripts для installable CLI quality gates;
- sandbox hardening report с OS capability detection и resource limit policy;
...
AgentHub — open-source проект под Apache License 2.0. Коммерческое использование, изменение, распространение и производные работы разрешены по условиям лицензии. При распространении сохраняйте `LICENSE` и `NOTICE`.
